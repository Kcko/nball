...
// Round 1
function playoffsRound1($seed) {
	//1 v 8 - R1G1
	$round1Game[0][0] = $seed[0]["TEAMNUM"] . ":" . $seed[7]["TEAMNUM"];
	$round1Game[0][1] = $seed[7]["TEAMNUM"] . ":" . $seed[0]["TEAMNUM"];
	$round1Game[0][2] = $seed[0]["TEAMNUM"] . ":" . $seed[7]["TEAMNUM"];
	
	//2 v 7 - R1G2
	$round1Game[1][0] = $seed[1]["TEAMNUM"] . ":" . $seed[6]["TEAMNUM"];
	$round1Game[1][1] = $seed[6]["TEAMNUM"] . ":" . $seed[1]["TEAMNUM"];
	$round1Game[1][2] = $seed[1]["TEAMNUM"] . ":" . $seed[6]["TEAMNUM"];
	
	//3 v 6 - R1G3
	$round1Game[2][0] = $seed[2]["TEAMNUM"] . ":" . $seed[5]["TEAMNUM"];
	$round1Game[2][1] = $seed[5]["TEAMNUM"] . ":" . $seed[2]["TEAMNUM"];
	$round1Game[2][2] = $seed[2]["TEAMNUM"] . ":" . $seed[5]["TEAMNUM"];
	
	//4 v 5 - R1G4
	$round1Game[3][0] = $seed[3]["TEAMNUM"] . ":" . $seed[4]["TEAMNUM"];
	$round1Game[3][1] = $seed[4]["TEAMNUM"] . ":" . $seed[3]["TEAMNUM"];
	$round1Game[3][2] = $seed[3]["TEAMNUM"] . ":" . $seed[4]["TEAMNUM"];
...
function playoffsRound2($seed) {
	//R1G1 V R1G4 - R2G1
	$round2Game[0][0] = $seed[0][0]["TEAMNUM"] . ":" . $seed[0][1]["TEAMNUM"];
	$round2Game[0][1] = $seed[0][1]["TEAMNUM"] . ":" . $seed[0][0]["TEAMNUM"];
	$round2Game[0][2] = $seed[0][0]["TEAMNUM"] . ":" . $seed[0][1]["TEAMNUM"];
	
	//R1G2 V R1G3 - R2G2
	$round2Game[1][0] = $seed[1][0]["TEAMNUM"] . ":" . $seed[1][1]["TEAMNUM"];
	$round2Game[1][1] = $seed[1][1]["TEAMNUM"] . ":" . $seed[1][0]["TEAMNUM"];
	$round2Game[1][2] = $seed[1][0]["TEAMNUM"] . ":" . $seed[1][1]["TEAMNUM"];
...
// Conference Finals
function playoffsRound3($seed) {
	//R2G1 V R2G1 - R3G1
//	print_r($seed);
	
	$round3Game[0][0] = $seed[0][0]["TEAMNUM"] . ":" . $seed[0][1]["TEAMNUM"];
	$round3Game[0][1] = $seed[0][1]["TEAMNUM"] . ":" . $seed[0][0]["TEAMNUM"];
	$round3Game[0][2] = $seed[0][0]["TEAMNUM"] . ":" . $seed[0][1]["TEAMNUM"];
...
// NBA Finals
function playoffsRound4($seed) {
	//Winners R3G1
	$round3Game[0][0] = $seed[0] . ":" . $seed[1];
	$round3Game[0][1] = $seed[1] . ":" . $seed[0];
	$round3Game[0][2] = $seed[0] . ":" . $seed[1];
	$round3Game[0][3] = $seed[1] . ":" . $seed[0];
	$round3Game[0][4] = $seed[0] . ":" . $seed[1];
...
function createPlayoffsRound1($PlayOffSeeds, $rowsetR1, $bgColor) {
	$highSeed = 0;
	$lowSeed = 7;
...
function createPlayoffsRound2($PlayOffSeeds, $rowsetR2, $bgColor) {
...
function createPlayoffsRound3($PlayOffSeeds, $rowsetR3, $bgColor) {
//	print_r($PlayOffSeeds);
//	echo "<pre>";
//	print_r($rowsetR3);
	include("config.php");
...
function createPlayoffsRound4($PlayOffSeeds1,$PlayOffSeeds2, $rowsetR4, $bgColor) {
