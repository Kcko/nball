...
<ul id="menu">
		...
		<li><a onkeypress="resetMenu('m1'); return false;" onclick="resetMenu('m1'); return false;" href="#">Standings</a></li><ol class="submenu" id="m1"><li><a href="..\viewstandings.php">Division</a></li><li><a href="..\viewstandings.php?viewType=conf">Conference</a></li><li><a href="..\viewstandings.php?seasonID=1">03-04 Standings</a></li><li><a href="..\viewplayoffs.php?seasonID=1">03-04 Playoffs</a></li></ol>
		<li><a onkeypress="resetMenu('m2'); return false;" onclick="resetMenu('m2'); return false;" href="#">Players</a></li><ol class="submenu" id="m2"><li><a href="..\viewplayerlist.php">Player List</a></li></ol>
		...
		<li><a onkeypress="resetMenu('m4'); return false;" onclick="resetMenu('m4');" href="#">Schedule</a><ol class="submenu" id="m4"><li><a href="..\viewfullschedule.php">Full Schedule</a></li><li><a href="..\viewfullschedule.php?teamID=Season0304">03-04 Schedule</a></li></ol></li>
